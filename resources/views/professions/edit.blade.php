<x-app-layout>
    ...
    <form action="{{ route('professions.update', $profession) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')

        <div>
            <x-label for="name_ar" :value="__('Name (Arabic)')" />
            <x-input id="name_ar" type="text" name="name_ar" :value="old('name_ar', $profession->name_ar)" required
        ...
        <div>
            ...
            <x-input id="name_en" type="text" name="name_en" :value="old('name_en', $profession->name_en)"
