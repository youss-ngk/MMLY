                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.regions.update', $region) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name_ar" name="name_ar" type="text" class="mt-1 block w-full" :value="old('name_ar', $region->name_ar)" required autofocus />
                            <x-input-error class="mt-2" :messages="$errors->get('name_ar')" />
                        </div>

                        <div>
                            <x-input-label for="name_en" :value="__('English Name')" />
                            <x-text-input id="name_en" name="name_en" type="text" class="mt-1 block w-full" :value="old('name_en', $region->name_en)" required />
